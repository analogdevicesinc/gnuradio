...
void bind_cvsd_encode_sb(py::module& m)
{
    ...
    py::class_<cvsd_encode_sb,
        ...
        .def("min_step", &cvsd_encode_sb::min_step, D(cvsd_encode_sb, min_step))


        .def("max_step", &cvsd_encode_sb::max_step, D(cvsd_encode_sb, max_step))


        .def("step_decay", &cvsd_encode_sb::step_decay, D(cvsd_encode_sb, step_decay))


        .def("accum_decay", &cvsd_encode_sb::accum_decay, D(cvsd_encode_sb, accum_decay))


        .def("K", &cvsd_encode_sb::K, D(cvsd_encode_sb, K))


        .def("J", &cvsd_encode_sb::J, D(cvsd_encode_sb, J))


        .def("pos_accum_max",
             &cvsd_encode_sb::pos_accum_max,
             D(cvsd_encode_sb, pos_accum_max))


        .def("neg_accum_max",
             &cvsd_encode_sb::neg_accum_max,
